...
export const SubCategoryImage = (props: SubCategoryImagesProps)=>{
    const { values } = props
    ...
    return (
        <AdaptableCard className="mb-4">
            <h5>SubCategory Image</h5>
            <p className="mb-6">Add or change image for the Subcategory</p>
            <FormItem>
                <Field name = "imgList">
