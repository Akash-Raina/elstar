...
import OpeningLeaveBalanceSearch from './OpeningLeaveBalanceSearch'

export const OpeningLeaveBalanceTableTools = () => {
    const navigate = useNavigate()
    return (
        <div className="flex flex-col lg:flex-row lg:items-center">
            <OpeningLeaveBalanceSearch/>
            ...
            <div className="block lg:inline-block md:mb-0 mb-4">
                <Button block variant="solid" color='red' size="sm" icon={<HiPlusCircle />} onClick={()=>{navigate('/addopeningleave')}}>
                    Add
                </Button>
            </div>
        </div>
