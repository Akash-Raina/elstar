...
import BankBranchMasterSearch from './BankBranchMasterSearch'

export const BankBranchMasterTableTools = () => {
    const navigate = useNavigate()
    return (
        <div className="flex flex-col lg:flex-row lg:items-center">
            <BankBranchMasterSearch/>
            ...
            <div className="block lg:inline-block md:mb-0 mb-4">
                <Button block variant="solid" color='red' size="sm" icon={<HiPlusCircle />} onClick={()=>{navigate('/addbankbranchmaster')}}>
                    Add
                </Button>
            </div>
        </div>
