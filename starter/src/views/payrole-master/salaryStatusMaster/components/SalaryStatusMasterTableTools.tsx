...
import SalaryStatusMasterSearch from './SalaryStatusMasterSearch'

export const SalaryStatusMasterTableTools = () => {
    const navigate = useNavigate()
    return (
        <div className="flex flex-col lg:flex-row lg:items-center">
            <SalaryStatusMasterSearch/>
            ...
            <div className="block lg:inline-block md:mb-0 mb-4">
                <Button block variant="solid" color='red' size="sm" icon={<HiPlusCircle />} onClick={()=>{navigate('/addsalarystatus')}}>
                    Add
                </Button>
            </div>
        </div>
