...
import { RetentionData } from "./components/RetentionData";
...
export const RetentionForm = forwardRef<FormikRef, MainForm>((props, ref)=>{
...
RetentionForm.displayName = 'RetentionForm'