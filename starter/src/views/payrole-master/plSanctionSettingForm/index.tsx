...
export const PlSanctionSettingForm = forwardRef<FormikRef, MainForm>((props, ref)=>{

    const {
        type, 
        initialData = {
            pl_sanction_days: '',
            on_payable_days_completed: ''
        },
        onFormSubmit,
        onDiscard, 
        onDelete
...
PlSanctionSettingForm.displayName = 'PlSanctionSettingForm'