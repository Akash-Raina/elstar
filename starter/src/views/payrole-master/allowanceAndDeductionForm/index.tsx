...
export const AllowanceAndDeductionForm = forwardRef<FormikRef, MainForm>((props, ref)=>{
            ...
            {({values, touched, errors, isSubmitting}) => (
                    <Form>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                                ...
                                <AmountList type="Allowance"/>
                                <AmountList type="Deduction"/>
                        </div>
                            <div
...
AllowanceAndDeductionForm.displayName = 'AllowanceAndDeductionForm'