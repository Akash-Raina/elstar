...
import { OtherIncomeType } from "./components/OtherIncomeType";
...
export const OtherIncomeForm = forwardRef<FormikRef, MainForm>((props, ref)=>{
...
OtherIncomeForm.displayName = 'OtherIncomeForm'