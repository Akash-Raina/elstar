...
export type TenderFormModel = InitialData

export type TenderSetSubmitting = (isSubmitting: boolean) => void
...
type MainForm = {
    ...
    onDiscard ?: ()=>void
    onDelete ?: OnDelete
    onFormSubmit: (FormData: InitialData, setSubmitting: TenderSetSubmitting) => void
}
...
export const TenderForm = forwardRef<FormikRef, MainForm>((props, ref)=>{
    ...
    return <>
        <Formik
            ...
            onSubmit={(values:TenderFormModel, {setSubmitting})=>{
