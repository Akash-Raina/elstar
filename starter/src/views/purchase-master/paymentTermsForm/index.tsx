...
export type PaymentFormModel = InitialData

export type PaymentSetSubmitting = (isSubmitting: boolean) => void
...
type PaymentForm = {
    ...
    onDiscard ?: ()=>void
    onDelete ?: OnDelete
    onFormSubmit: (FormData: InitialData, setSubmitting: PaymentSetSubmitting) => void
}
...
export const PaymentForm = forwardRef<FormikRef, PaymentForm>((props, ref)=>{
    ...
    return <>
        <Formik
            ...
            onSubmit={(values:PaymentFormModel, {setSubmitting})=>{
