...
export type DistrictFormModel = InitialData

export type DistrictSetSubmitting = (isSubmitting: boolean) => void
...
type DistrictForm = {
    ...
    onDiscard ?: ()=>void
    onDelete ?: OnDelete
    onFormSubmit: (FormData: InitialData, setSubmitting: DistrictSetSubmitting) => void
}
...
export const DistrictForm = forwardRef<FormikRef, DistrictForm>((props, ref)=>{
    ...
    return <>
        <Formik
            ...
            onSubmit={(values:DistrictFormModel, {setSubmitting})=>{
...
DistrictForm.displayName = 'DistrictForm'