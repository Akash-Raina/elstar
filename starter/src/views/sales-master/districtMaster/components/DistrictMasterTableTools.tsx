...
import DistrictMasterSearch from './DistrictMasterSearch'

export const DistrictMasterTableTools = () => {
    const navigate = useNavigate()
    return (
        <div className="flex flex-col lg:flex-row lg:items-center">
            <DistrictMasterSearch />
            ...
            <div className="block lg:inline-block md:mb-0 mb-4">
                <Button block variant="solid" color='red' size="sm" icon={<HiPlusCircle />} onClick={()=>{navigate('/adddistrictmaster')}}>
                    Add
                </Button>
            </div>
        </div>
