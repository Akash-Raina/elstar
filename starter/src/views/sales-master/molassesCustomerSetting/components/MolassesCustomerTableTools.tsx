...
import MolassesCustomerSearch from './MolassesCustomerSearch'

export const MolassesCustomerTableTools = () => {
    const navigate = useNavigate()
    return (
        <div className="flex flex-col lg:flex-row lg:items-center">
            <MolassesCustomerSearch />
            ...
            <div className="block lg:inline-block md:mb-0 mb-4">
                <Button block variant="solid" color='red' size="sm" icon={<HiPlusCircle />} onClick={()=>{navigate('/addmolassescustomer')}}>
                    Add
                </Button>
            </div>
        </div>
