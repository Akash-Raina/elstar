...
import CustomerMasterSearch from './CustomerMasterSearch'

export const CustomerMasterTableTools = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row lg:items-center">
            ...
            <div className="block lg:inline-block md:mb-0 mb-4">
                <Button block variant="solid" color='red' size="sm" icon={<HiPlusCircle />} onClick={()=>{navigate('/addcustomermaster')}}>
                    Add
                </Button>
            </div>
        </div>
